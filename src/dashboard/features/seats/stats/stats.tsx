  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 col-span-4">
      ...
      <StatsCard
        ...
        tip="Seats with no Copilot activity in the last 30 days. Calculation: total seats − active seats."
